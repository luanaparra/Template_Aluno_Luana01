function qtdAlunos(){
    ...
    document.getElementById('add_inputs').innerHTML = text
}
...
function buttonMostrar(){
    ...
    if (i == prova.length){
        ...
        document.getElementById('informacoes').innerHTML = ind + '<h3>Media geral: ' + geral + '</h3>' + '<h3>Media provas: ' + media_p + '</h3>' + '<h3>Media Trabalhos: ' + media_t + '</h3>' + '<h3>Menor e maior notas prova: ' + menor_nota_p + '//' + maior_nota_p + '</h3>' + '<h3>Menor e maior notas trabalho: ' + menor_nota_t + '//' + maior_nota_t + '</h3>'
    }
}